...
const ALL_ROOM_TEMPLATES=["calibration_gallery","calibration_crossroads","calibration_wells","calibration_orbit","twin_gates","broken_ring","long_lanes","staggered_columns","split_chamber","hourglass_vault","serpentine_stack","open_confluence","idol_fortress","warden_ring"];
...
export const MAP_STYLES:MapStyleDefinition[]=[
 ...
 {id:"training-grid",name:"Calibration Grid",description:"A minimal high-clarity simulation for calibration chambers.",performanceTier:"low",unlockRequirementId:"rooms-3",compatibleRoomTemplateIds:["calibration_gallery","calibration_crossroads","calibration_wells","calibration_orbit","open_confluence"],palette:{void:"#071113",floorA:"#163238",floorB:"#122a30",grid:"#4ad6d633",detail:"#55c9c5",wall:"#315258",wallInset:"#1d3b41",accent:"#ffd05e",vignette:"#02090bdd"}},
];
